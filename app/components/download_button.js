...
class DownloadButton extends Component {
    render() {
        // NOTE(aleksey): Chrome does not support target="_blank" for data URIs (Firefox does).
        return <a className="output-button" href={this.props.placeHolderImageActive ? "/static/img/default.png" : this.props.outputPicture} download>
