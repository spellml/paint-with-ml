...
class FancyButton extends Component {
    ...
    // NOTE: JS hover events are necessary because the CSS :hover event handler cannot propagate
    // from the button element to the SVG element directly, as needed here. We have to handle this
    // transition in JS in getButtonImage().
    onMouseEnter() { this.setState({'hover': true}); }
    onMouseLeave() { this.setState({'hover': false}); }

    getButtonImage() {
        const imageFill = (this.state.hover && this.props.visualType == "unfilled") ? 'black' : 'white';
