> This directory is a copy of the [NVLabs/SPADE](https://github.com/NVlabs/SPADE) and [vacancy/Synchronized-BatchNorm-PyTorch](https://github.com/vacancy/Synchronized-BatchNorm-PyTorch) GH repositories.
